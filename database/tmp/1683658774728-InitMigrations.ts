...
export class InitMigrations1683658774728 implements MigrationInterface {
    name = 'InitMigrations1683658774728'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "usuarios"."persona" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombres" character varying(100) NOT NULL, "primer_apellido" character varying(100) NOT NULL, CONSTRAINT "PK_13aefc75f60510f2be4cd243d71" PRIMARY KEY ("id"))`);
